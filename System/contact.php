...
<head>
    ...
    <meta property="og:image:alt" content="HyreUp" />
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								...
								<li>
										<h5>Email</h5><a href="mailto:hyreup.here@gmail.com">hyreup.here@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+918846533599">+918846533599</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About HyreUp</h5>
											<p>HyreUp is a job portal, online job management system Developed by Hyreup Team for his project in february 2018.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">HyreUp Contact</h5>
								
								<p>Address : Takoradi, School Junction PO.BOX AX40</p>
								<p>Email : <a href="mailto:hyreup.here@gmail.com">hyreup.here@gmail.com</a></p>
								<p>Phone : <a href="tel:+918846533599">+918846533599</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> HyreUp Software Development</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Hyreup Team</a></li>
								</ul>
